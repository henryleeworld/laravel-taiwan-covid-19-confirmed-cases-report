...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="container-fluid col-sm-6 mt-3">
            <table id="breakdown-of-confirmed-cases-by-district-report" class="table table-striped cell-border compact" style="width: 100%;">
                <thead>
                    <tr>
                        <th>{{ __('Case study date') }}</th>
                        <th>{{ __('City') }}</th>
                        <th>{{ __('Area') }}</th>
                        <th>{{ __('Newly confirmed cases') }}</th>
